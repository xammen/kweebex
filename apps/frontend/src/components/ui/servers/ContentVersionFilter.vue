...
import { FilterIcon } from '@kweebex/assets'
import Checkbox from '@kweebex/ui/src/components/base/Checkbox.vue'
import ManySelect from '@kweebex/ui/src/components/base/ManySelect.vue'
