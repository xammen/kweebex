...
// i18n symbols that should be imported from @kweebex/ui
...
const VALID_IMPORT_SOURCES = ['@kweebex/ui']
...
function main() {
	...
	if (verbose) {
		console.log(theme.muted('  Tip: Import these symbols from @kweebex/ui'))
		console.log(theme.muted('  Example: import { useVIntl, defineMessages } from \'@kweebex/ui\''))
		console.log()
	}
